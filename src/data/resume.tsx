...
export const DATA = {
  name: "Sajjan Kumar",
  initials: "SK",
  url: "https://github.com/sajjannnn",
  location: "Delhi, India",
  // locationLink: "https://www.google.com/maps/place/sanfrancisco",
  description: "B.Tech Student & Full-Stack Developer passionate about building AI-powered applications. I love creating intelligent solutions that solve real-world problems.",
  summary:
  ...
  contact: {
    ...
    social: {
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/sajjan-kumar18/",
        icon: Icons.linkedin,
  ...
  projects: [
    {
      ...
      links: [
        ...
        {
          type: "GitHub",
          href: "https://github.com/sajjannnn/Studify",
    ...
    },
    {
      ...
      dates: "2025",
      active: true,
      description: "Upload your meal photo, AI calculate calories, and get recipes from ingredients available in your kitchen.",
      technologies: ["Typescript", "TailwindCSS", "Gemini API", "Firebase"],
      links: [
        {
          type: "Website",
          href: "https://calorie-tracker-ten-omega.vercel.app/",
        ...
        {
          type: "Source",
          href: "https://github.com/sajjannnn/CalorieTracker",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "",
    ...
    },
    {
      ...
      dates: "2025",
      active: true,
      description: "Netflix-style streaming UI with AI-assisted movie search and real-time data from the TMDB API.",
      technologies: ["TMDB API", "Firebase", "Typescript", "TailwindCSS", "React"],
      links: [
        {
          type: "Website",
          href: "https://netflix-gpt-sajjannnns-projects.vercel.app/",
          icon: <Icons.globe className="size-3" />,
        },
        {
          type: "Source",
          href: "https://github.com/sajjannnn/NetflixGPT",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "",
    ...
    {
      title: "BiteNow",
      href: "https://bite-now-psi.vercel.app/",
      dates: "2025",
      active: true,
      description: "Swiggy-inspired food delivery web app featuring restaurant discovery, menu browsing, and real-time cart management.",
      technologies: ["Typescript", "TailwindCSS", "API", "Redux", "React"],
      links: [
        {
          type: "Website",
          href: "https://bite-now-psi.vercel.app/",
        ...
        {
          type: "Source",
          href: "https://github.com/sajjannnn/BiteNow",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "",
